...
const badges = [
  ...
  { id: 4, name: "Problem Solver", description: "Solved 50+ problems", icon: "https://api.dicebear.com/9.x/bottts/svg?seed=Sophia" },
  { id: 5, name: "Consistency King", description: "Active for 30 days", icon: "https://api.dicebear.com/9.x/bottts/svg?seed=Jude" },
  { id: 6, name: "Algorithm Master", description: "Mastered 10 algorithms", icon: "https://api.dicebear.com/9.x/bottts/svg?seed=Avery" },
];


const BadgesEarned = () => {
  return (
    <div className="w-full md:w-1/2 bg-[#1D1D1D] rounded-xl shadow-lg p-6 border border-gray-800 overflow-y-auto max-h-[300px] hover:border-gray-700 transition-all duration-300">
      <h3 className="text-xl font-semibold text-white mb-4 font-coinbase-display f8xe" >Badges Earned</h3>
