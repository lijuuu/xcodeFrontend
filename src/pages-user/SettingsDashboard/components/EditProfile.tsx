...
import useCountries from "@/hooks/useCountries"; // Assuming this is correctly typed elsewhere
...
const EditProfileCard = ({ user }: { user: any }) => {
  ...
  }, [userProfile]); // Added dependency to ensure updates when userProfile changes
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      dispatch(getUser() as any); // Assuming getUser is a thunk action
    } catch (error) {
  ...
  return (
    <div className="w-full max-w-4xl bg-night-black rounded-lg p-8 shadow-lg max-h-[80vh] overflow-y-auto font-coinbase-sans">
...
// Updated CountriesWithFlags Component (unchanged)
